...
import { JobsScheduler } from "./src/utils/nodeSchedule.js";
...
// const server = http.createServer(app); // Não utilizado(Recomendação do professor Gustavo)
...
app.listen(configDotenv.PORT, async () => {
  console.log("\x1b[34m" + "━".repeat(71) + "\x1b[0m");
  console.log(`\x1b[36m${gestcareASCII}\x1b[0m`);
  console.log("\x1b[34m" + "━".repeat(71) + "\x1b[0m");
  console.log(
    `\x1b[36m|\x1b[0m  Server rodando na porta: \x1b[34m${configDotenv.PORT} \x1b[36m${" ".repeat(37)}|\x1b[0m`,
  );
  console.log(
    `\x1b[36m|\x1b[0m  Banco  rodando na porta: \x1b[34m${configDotenv.DB_PORT} \x1b[36m${" ".repeat(37)}|\x1b[0m`,
  );
  console.log(
    `\x1b[36m|\x1b[0m  Banco utilizado: \x1b[34m${configDotenv.DB_NAME} \x1b[36m${" ".repeat(41)}|\x1b[0m`,
  );
  console.log("\x1b[34m" + "━".repeat(71) + "\x1b[0m");

  const iniciados = await jobsScheduler.IniciarJobsLembretes();
  !iniciados
    ? console.log(`\x1b[31m Falha ao iniciar jobs dos lembretes! \x1b[0m`)
    : console.log(`\x1b[32m Jobs dos lembretes iniciados!\x1b[0m`);
});
