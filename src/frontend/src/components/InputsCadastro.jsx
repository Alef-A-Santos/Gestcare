    ...
    <div className="flex justify-center items-center flex-col gap-1 overflow-y-hidden">
      <div className="w-100 flex flex-col justify-center items-center">
        ...
        <Inputs
          ...
          className="border-2 p-2 rounded-lg bg-white border-red-300 w-full sm:w-100 outline-none focus:border-red-400 focus:border-2 text-start  text-grey-300 pl-9"
        />
      </div>
      ...
      <div className="w-100 flex flex-col justify-center lg:justify-start items-center">
        ...
        <Inputs
          ...
          className="border-2 p-2 text-start rounded-lg bg-white border-red-300 w-full sm:w-100 outline-none  focus:border-red-400  focus:border-2    text-gray-500   pl-9 [&::-webkit-calendar-picker-indicator]:opacity-0 [&::-webkit-calendar-picker-indicator]:cursor-pointer"
        />
      </div>
    </div>
  );
